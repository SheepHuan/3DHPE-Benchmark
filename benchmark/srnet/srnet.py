...
from models.srnet.srnet_utils.flex_layer import FlexGroupLayer
from models.srnet.srnet_utils.group_index import get_input, shrink_output

from models.srnet.cfg import parse_args
args = parse_args()
