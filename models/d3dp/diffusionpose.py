...
from models.d3dp.mixste import *
...
class D3DP(nn.Module):
    ...
    def __init__(self, joints_left, joints_right, is_train=True, num_proposals=1, sampling_timesteps=1,number_of_frames=1,test_time_augmentation=False,timestep=1,scale=1.0,cs=512,dep=8):
        super().__init__()
        self.device='cpu'
        ...
        self.pose_estimator = MixSTE2(num_frame=self.frames, num_joints=17, in_chans=2, embed_dim_ratio=cs, depth=dep,
    ...
    def forward(self, input_2d, input_3d=None, input_2d_flip=None):
    ...
    def prepare_diffusion_concat(self, pose_3d):
        ...
        noise = torch.randn(self.frames, 17, 3)
